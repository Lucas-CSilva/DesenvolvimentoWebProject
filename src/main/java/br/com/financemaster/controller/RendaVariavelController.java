...
public class RendaVariavelController {
    ...
    public ResponseEntity<List<RendaVariavel>> getAll()
    {
        try 
        {
            List<RendaVariavel> contaBancaria = (List<RendaVariavel>) this.rendaVariavelRepository.findAll();
    ...
    public ResponseEntity<RendaVariavel> insert (@RequestBody RendaVariavel rendaVariavel)
    {  
        try
        {
    ...
    public ResponseEntity<RendaVariavel> update(@RequestBody RendaVariavel rendaVariavel)
    {
        try
        {
